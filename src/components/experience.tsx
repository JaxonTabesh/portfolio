...
export default function Experience() {
  return (
    <section id="2">
      <div className="flex h-full min-h-screen flex-col items-center md:pb-20 dark:text-gray-400">
          ...
          <div className="flex-1">
            <div className="flex max-w-7xl flex-col items-center justify-center px-10 py-10 md:py-0">
              ...
              <div className="pt-6 md:px-20">
                <p className="border-l border-gray-900 pl-3 text-left text-2xl dark:border-gray-400">
                  ...
                  Designed database tables, triggers, and RPCs, and integrated Retell.ai webhooks
                  through a Supabase Edge Function to automatically store and display AI phone call
                  data for clients. Currently in early testing before App Store release.
                </p>
              </div>
            </div>
          </div>
