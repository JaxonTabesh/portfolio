...
export default function About() {
  return (
    <section id="1">
      <div className="flex h-full min-h-screen flex-col items-center dark:text-neutral-400">
        <h2 className="text-6xl md:text-8xl">About</h2>
        <div className="flex max-w-7xl flex-grow flex-col items-center justify-center md:flex-row">
          <div className="flex-1">
            <div className="px-10 py-10 md:py-0">
              ...
              <p className="border-l border-neutral-900 pl-3 text-2xl dark:border-neutral-400">
                ...
                {"I\'m "}
                currently building a cross-platform app at
                <span className="text-[#e03131]"> TakeMyCall.ai</span>, which provides AI phone call
                assistants for small businesses through Retell AI. The app lets businesses view and
                ...
                <span className="text-[#e03131]"> president</span> of both the Computer Science Club
                and Phi Theta Kappa at MSJC, where I earned five associate degrees with honors.
              </p>
            </div>
          </div>
          <div className="flex-1">
            <div className="flex flex-wrap justify-center gap-6 py-10 md:py-0 [&>div>img]:h-[75px] [&>div>img]:object-contain md:[&>div>img]:h-[100px]">
